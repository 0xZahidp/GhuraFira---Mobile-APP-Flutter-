      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            const Text('Optional Filters', style: TextStyle(fontWeight: FontWeight.bold)),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          boxShadow: [BoxShadow(color: Colors.green.withOpacity(0.2), blurRadius: 6, offset: Offset(0, 3))],
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            const Text('Previous Searches', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
            TextButton(
              onPressed: () {
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 4),
              Text('${DateFormat('d MMM’yy').format(checkInDate)}  →  ${DateFormat('d MMM’yy').format(checkOutDate)}'),
